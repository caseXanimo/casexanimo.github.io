...
${\color{orange}2.}$ Type fdisk /dev/sd${\color{red}\mathbf{X}$ - ${\color{red}where\space \color{white}\mathbf{X}\space \color{red}define\space the\space letter\space of\space the\space drive\space you\space want\space to\space clear.}$
