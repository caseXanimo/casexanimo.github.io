...
${\color{orange}2.}$ Type fdisk /dev/sdX - ${\color{red}where\space mathbf{\color{white}X}}\space \color{red}define\space the\space letter\space of\space the\space drive\space you\space want\space to\space clear.}$
